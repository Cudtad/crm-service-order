...
function TaskDocumentDetail(props, ref) {
    // default service
    let emptyObject = {
        type: null,
        code: null,
    ...
    return (
        <Dialog
            ...
            contentClassName="p-0 task-document-detail"
            ...
            <Splitter style={{height: '100%'}}>
                <SplitterPanel size={70} className="flex align-items-center justify-content-center">
                    ...
                    && <>
                        ...
                        {/*<img style={{ width: '100%', height: '100%' }} src={`${appSettings.api.url}/storage/file/preview/${currentObject.file.id}`} />*/}
                    </>}
                    ...
                    <TabView>
                        ...
                        <TabPanel header={t('task.document.history')}>
                            ...
                            >
                                ...
                                <Column header={t('task.attachment.file.description')} field="description"></Column>
                            </DataTable>
                        </TabPanel>
                    </TabView>
                </SplitterPanel>
...
TaskDocumentDetail = forwardRef(TaskDocumentDetail);

export default TaskDocumentDetail;
