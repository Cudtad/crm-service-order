...
export const TaskAutoComplete = (props) => {
    ...
    const { value, onChange, className, groupIds, type, status, placeholder, itemDisplay } = props;
        ...
        <XAutoComplete
            ...
            completeMethod={async (paging, params) => {
                ...
                if (props.type === 'TEMPLATE') {
                    ...
                    res = await ProjectService.task.list(lazy);
                }
