...
import "features/task/scss/Task.scss"
...
import RequestDetail from 'features/task/components/RequestDetail';
...
export default function Task() {
    ...
    */
     ...
     */
    const createTask = () => {
        refTaskDetail.current.create(userLogin);
    }
    ...
    */
    ...
    return (
        <div className="page-container overflow-hidden">
                                                ...
                                                <Chip
                                                    ...
                                                    image={
                                                        task.requestedByUser.avatar
                                                            ? `${process.env.REACT_APP_API_URL}storage/file/preview/${task.requestedByUser.avatar}`
                                                ...
                                                <Chip
                                                    ...
                                                    image={
                                                        task.responsibleUser.avatar
                                                            ? `${process.env.REACT_APP_API_URL}storage/file/preview/${task.responsibleUser.avatar}`
            ...
            <TaskBaseDetail ref={refTaskDetail} groups={groups} tasks={groupTasks} />
